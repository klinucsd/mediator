...
PGB_DATABASES="mediator = host=localhost port=5432 user=postgres"
...
cat <<- END > $INI
[databases]
mediator = host=localhost port=5432 user=postgres
...
#    rewrite_query_py_module_file = /home/pgbouncer/rewrite_query.py
    rewrite_query_py_module_file = /home/pgbouncer/src/query_rewriter/rewrite_query.py
    log_stats = 1
    auth_file = $USERLIST
